...
@section('content')
    <section class="container">
        ...
        <h1 class="d-flex justify-content-center mb-5 p-5">Dashboard</h1>
        ...
        {{-- Nouvelle catégories --}}
            <div class="card mb-5 col-md-5">
                <div class="card-body">
                <h5 class="card-title">Ajouter une nouvelle catégories</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="{{route("nouvelCategorie")}}" class="btn btn-primary">Create</a>
                </div>
            </div>
        </div>
