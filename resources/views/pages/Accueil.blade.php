...
@section('content')
    ...
    <section class="container mt-5">
        <h1 class="display-4 text-center">WLAOtaku</h1>
    </section>
    ...
    <section class="container-fluid d-flex justify-content-center align-items-end p-0 m-0 mt-5 mt-lg-3">
        ...
        <div id="eventCarousel" class=" col-12 col-lg-6 border carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="d-flex justify-content-center align-items-center p-5 hvr-shutter-out-vertical" style="height:50vh; background-color:orange">
                ...
                @foreach ($evenements as $evenement)
                    <div class="carousel-item position-relative">
                        <a href="/les_evenements/{{$evenement->id}}" class="text-decoration-none link-dark">
                            <div class="carousel_img" style="background-image: url(/storage/Evenements/photos/{{ $evenement->images }})"></div>
                            <div class="carousel_text d-flex justify-content-center align-items-center w-100 p-5 hvr-bounce-to-top">
            ...
            @foreach ($animes as $anime)
                @foreach ($anime->episodes as $episode)
                    <a href="/les_episodes/{{$episode->id}}"
                        class="card_box d-flex flex-column col-6 col-lg-3 link-dark text-decoration-none hvr-shrink me-5">
    ...
    <section class="mt-5 container-fluid d-flex flex-column mb-5">
        ...
        <div id="seasonalCarousel" class="carousel carousel-dark slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="seasonalCarousel_first_slide d-flex justify-content-center align-items-center p-5 hvr-shutter-out-vertical">
                        <a href="{{route("LesSeasonals")}}" class="p-5 text-decoration-none link-dark">
                            ...
                            @endforeach
                            <h3>Decouvrez ici l'actualité et les nouveautée de la communauté et de ses acteur</h3>
                    ...
                    @foreach ($seasonal->animes as $anime)
                        <div class="carousel-item"> 
                            ...
                            <div class="position-relative">
                                <div class="seasonalCarousel_img" style="background-image: url(/storage/Animes/photos/{{$anime->images}})">
                                </div>
                                <a href="/les_animes/{{$anime->id}}" class="seasonalCarousel_text d-flex flex-column align-items-center justify-content-center link-dark text-decoration-none hvr-shutter-out-vertical">
                                    
                                    <h4 class="display-2"><b>{{$anime->nom}}</b></h4>
            ...
            {{-- button --}}
            <button class="carousel-control-prev" type="button" data-bs-target="#seasonalCarousel" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#seasonalCarousel" data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
    ...
    <section class="mt-5 container-fluid d-flex flex-column mb-5">
        ...
        @foreach ($articles as $article)
            <a href="/les_articles/{{$article->id}}" class="d-flex mb-3 thumb_box text-decoration-none text-dark">
                <div class="col-4 col-lg-3 thumb_img"
                    style="background-image: url(/storage/Articles/photos/{{ $article->images }})"></div>
                <div class="d-flex flex-column align-items-center justify-content-center col-8 col-lg-9 p-5 hvr-sweep-to-right border">
                    <h3>{{ $article->titre }}</h3>
