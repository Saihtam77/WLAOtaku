...
@section('content')
    <section class="container d-flex flex-column">
        {!! Form::open(["action"=>"Blog\EvenementsController@store","method"=>"post","enctype"=>"multipart/form-data","class"=>"d-flex flex-column"]) !!}
            
            <div class="d-flex flex-column form-group">
                {!! Form::label("nom","Nom") !!}
                {!! Form::text("nom","", ["class"=>"form-control","placeholder"=>"Nom de l'évenement"]) !!}
            </div>
            ...
            <div class="d-flex flex-column form-group">
                ...
                {!! Form::text("adresse","", ["class"=>"form-control","placeholder"=>"Où ce déroule l'evenements?"]) !!}
            </div>
            ...
            <div class="d-flex flex-column form-group">
                ...
                {!! Form::textarea("description","", ["class"=>"form-control","placeholder"=>"Decrivez le contenu de l'évenements"]) !!}
            </div>
